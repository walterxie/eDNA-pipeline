...
pdf(paste(workingPath, figDir, "/all-elevation-alpha1-", otuThr, "-comparison.pdf", sep = ""), width=9, height=5)
attach(mtcars)
...
print(xtable(sig_table, caption = "The significance test of effective $\\alpha$ diversity as a function of elevation.", 
	label = "tab:sigAlpha1Elev", caption.placement = "top"), 
